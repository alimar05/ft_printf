...
/*   Updated: 2019/03/07 21:05:09 by rymuller         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*h_else_hh_size(va_list arg, t_specifier *specifier, char *buffer)
{
	if (specifier->size[0] == 'h' && specifier->size[1] == '\0')
	{
		...
		return (ft_itoa_base(specifier->num_int.num_s, specifier->base, buffer));	
	}
	else if (specifier->size[0] == 'h' && specifier->size[1] == 'h')
	{
		...
		return (ft_itoa_base(specifier->num_int.num_c, specifier->base, buffer));
	}
	return (NULL);
}
...
char	*l_else_ll_size(va_list arg, t_specifier *specifier, char *buffer)
{
	if (specifier->size[0] == 'l' && specifier->size[1] == '\0')
	{
		...
		return (ft_itoa_base(specifier->num_int.num_l, specifier->base, buffer));
	}
	else if (specifier->size[0] == 'l' && specifier->size[1] == 'l')
	{
		...
		return (ft_itoa_base(specifier->num_int.num_ll, specifier->base, buffer));
	}
	return (NULL);
}
